<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            <p>Dummy Heading</p>
            <li class="">
                <a href="#BooksMenu" data-toggle="collapse" aria-expanded="false">Books</a>
                <ul class="collapse list-unstyled" id="BooksMenu">
                    <li><a href="{{ route("BookListGet",['SiteType'=>$SiteType,'SiteId'=>$SiteId]) }}">Books List</a></li>
                    <li><a href="{{ route("AddBookGet",['SiteType'=>$SiteType,'SiteId'=>$SiteId]) }}" >Add Book</a></li>
                </ul>
            </li>
            <li class="">
